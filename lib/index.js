...
exports.createError = function (message, scheme, attributes) {          // Or function (message, wwwAuthenticate[])

    var err = internals.create(500, message, undefined, exports.createError);
